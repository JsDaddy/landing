                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="item-wrapper">
                            ...
                            <div class="button-block">
                                <h4>
                                    Подробный курс Angular JS
                                </h4>
                                <span class="prices">
                                   Стоимость: 3000грн
                               </span>
                                <div class="duration">
                                    Продолжительность 10 занятий (1 месяц)
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="item-wrapper">
                            ...
                            <div class="button-block">
                                <h4>
                                    WEB дизайн - быстрый старт
                                </h4>
                                <div class="prices">
                                    Стоимость: 3000грн (экв ~ $100)
                                </div>
                                <div class="duration">
                                    Продолжительность 10 занятий (1 месяц)
                                </div>
                ...
                <div class="slider-teaches">
                    <div class="item-wrapper">
                        <div class="photo-wrapper">
                            <img src="https://previews.123rf.com/images/martinussumbaji/martinussumbaji1608/martinussumbaji160800009/62244413-jesus-face-silhouette-art-design.jpg"
                                 alt="">
                        </div>
                        <div class="name">
                            Лимаренко Денис
                        ...
                        <div class="about">
                            <p>В разработке более 3.5 лет. Опыт в верстке сайтов различной сложности от лендингов и
